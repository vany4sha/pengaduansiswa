                        ...
                        @if (Route::has('login'))
                            <nav class="-mx-3 flex flex-1 justify-end">
                                ...
                                @else
                                    ...
                                    <button class="btn mr-4"><a href="{{ route('news.index') }}">News</a></button>

                                    <button class="btn" onclick="my_modal_3.showModal()">Login</button>
                                    ...
                                    <button class="btn ml-4" onclick="my_modal_2.showModal()">Register</button>
                                    ...
                                    <div class="modal-box">
                                        <form method="POST" action="{{ route('register') }}">
                                            ...
                                            <div class="mt-4">
                                                ...
                                                <x-text-input id="password_confirmation" class="block mt-1 w-full p-2"
                                                                type="password"
                                            ...
                                            <div class="mt-4">
                                                ...
                                                <select id="role" name="role" class="block mt-1 w-full p-2" required>
